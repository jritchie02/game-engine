...
public:
    SpriteSheet();
    SpriteSheet(const std::string &file_name, int tile_size, int tile_cols, int tile_rows)
        : m_file_name(file_name), m_tile_size(tile_size), m_tileset_cols(tile_cols),
          m_tileset_rows(tile_rows) {}
